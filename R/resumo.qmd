...
Um dos métodos amplamente usados na literatura é é baseado no índice $J$, proposto por Youden (1950) e que considera tanto sensibilidade quanto especificidade para definir o valor "ótimo". Este método define o ponto de corte ótimo como o ponto que maximiza a função de Youden, isto é, que maximiza
