...
```{r}
#| label: fig-croc_arvore
#| fig-cap: "Curva ROC da árvore"
#| fig-align: center
# calcula a area abaixo da curva ROC
roc_arvore <- pROC::roc(dados$atraso, predict(modelo_arvore))

auc_arvore <- pROC::auc(roc_arvore)

pROC::ggroc(roc_arvore,
            linewidth = 1,
            colour = "steelblue") +
  ggplot2::labs(
    title = "",
