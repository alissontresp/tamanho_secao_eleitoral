...
A @fig-histograma apresenta o histograma do número de eleitores aptos para o pleito de 2018 dentro das seções que foram 100% biométricas. Nota-se, para esse pleito, que há uma concentração de seções com número de eleitores aptos superior a 300. Ainda, há um número expressivo de seções com mais de 400 eleitores. Esse fato pode estar associado as agregações que são realizadas durante a eleição. 

De maneira complementar, são apresentadas algumas medidas descritivas para o eleitorado apto na @tbl-resumo_estat. O número médio de eleitores aptos foi cerca de 304 eleitores com um desvio padrão de cerca de 66 eleitores. O valor mediano foi de 311, de modo que 50% das seções eleitorais no pleito de 2018 tinham valores de eleitorado apto igual ou superior a esse valor. Na @fig-bp_secoes (eu escolheria entre o boxplot ou histograma).
