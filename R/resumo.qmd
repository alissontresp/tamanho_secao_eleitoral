...
Serão estudadas duas situações para a definição de atraso nesse estudo:

-   Quando o tempo de atraso for maior que 45 minutos;

-   quando o tempo de atraso for maior que 1 hora.
...
curva_roc <- dados |>
   dplyr::mutate(atraso =
                  ifelse(tempo_atraso >= lubridate::hms("00:45:00"), 1, 0)
                ) |> 
